...
public class YagoBasedTypeSearcherTest {
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] { classesModel, dolceClassModel, new HashSet<Resource>(Arrays.asList(yagoA21)),
        ...
        testConfigs.add(new Object[] { classesModel, dolceClassModel, new HashSet<Resource>(Arrays.asList(yagoA22)),
                new HashSet<Resource>(Arrays.asList(yagoA22, dolceA2)) });
        // yagoA32 is the result
        testConfigs.add(new Object[] { classesModel, dolceClassModel, new HashSet<Resource>(Arrays.asList(yagoA32)),
        ...
        testConfigs.add(new Object[] { classesModel, dolceClassModel,
                ...
                new HashSet<Resource>(Arrays.asList(yagoA22, dolceA2, yagoA32, dolceA3, dolceA)) });
        return testConfigs;
    }
    ...
    public YagoBasedTypeSearcherTest(Model classesModel, Model dolceClassModel, Set<Resource> types,
    ...
    public void testFindUnlinkedDolceClasses() {
        ...
        YagoBasedTypeSearcher searcher = new YagoBasedTypeSearcher(classesModel, dolceClassModel);
