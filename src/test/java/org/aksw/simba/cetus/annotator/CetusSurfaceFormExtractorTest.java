    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] {
                new DocumentImpl(
                        ...
                        Arrays.asList((Marking) new NamedEntity(0, 12, "http://dbpedia.org/resource/Brian_Banner"))),
                new HashSet<ExtendedTypedNamedEntity>(Arrays.asList(
                        new ExtendedTypedNamedEntity(18, 17, CetusSurfaceFormExtractor.BASE_URI + "FictionalVillain",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "fictional villain"),
        ...
        testConfigs.add(new Object[] {
                new DocumentImpl(
                        ...
                        Arrays.asList((Marking) new NamedEntity(0, 24, "http://dbpedia.org/resource/Avex"))),
                new HashSet<ExtendedTypedNamedEntity>(Arrays.asList(
                        new ExtendedTypedNamedEntity(101, 15, CetusSurfaceFormExtractor.BASE_URI + "HoldingCompany",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "holding company"),
                        new ExtendedTypedNamedEntity(109, 7, CetusSurfaceFormExtractor.BASE_URI + "Company",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "company"))) });
        testConfigs.add(new Object[] {
        ...
        testConfigs.add(new Object[] {
                new DocumentImpl(
                        ...
                        Arrays.asList((Marking) new NamedEntity(2, 10, "http://dbpedia.org/resource/CPU_socket"))),
                new HashSet<ExtendedTypedNamedEntity>(Arrays.asList(
                        new ExtendedTypedNamedEntity(30, 20, CetusSurfaceFormExtractor.BASE_URI + "MechanicalComponent",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "mechanical component"),
                        new ExtendedTypedNamedEntity(41, 9, CetusSurfaceFormExtractor.BASE_URI + "Component",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "component"))) });
        testConfigs
                .add(new Object[] {
                        new DocumentImpl(
                ...
                new HashSet<ExtendedTypedNamedEntity>(Arrays.asList(
                        new ExtendedTypedNamedEntity(27, 16, CetusSurfaceFormExtractor.BASE_URI + "Bench-topDevice",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "bench-top device"),
                        new ExtendedTypedNamedEntity(37, 6, CetusSurfaceFormExtractor.BASE_URI + "Device",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "device"))) });
        testConfigs.add(new Object[] {
                new DocumentImpl(
                        "Štvrtok is a village in Trencín District in the Trencín Region of north-western Slovakia.",
                        Arrays.asList((Marking) new NamedEntity(0, 7, "http://dbpedia.org/resource/Štvrtok"))),
                new HashSet<ExtendedTypedNamedEntity>(Arrays
                        .asList(new ExtendedTypedNamedEntity(13, 7, CetusSurfaceFormExtractor.BASE_URI + "Village",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "village"))) });
        testConfigs.add(new Object[] {
                new DocumentImpl(
                        "In meteorology, virga is an observable precipitation shaft that falls from a cloud but evaporates or sublimes before reaching the ground. At high altitudes the precipitation falls mainly as ice crystals before melting and finally evaporating; this is often due to compressional heating, because the air pressure increases closer to the ground.",
                        Arrays.asList((Marking) new NamedEntity(16, 5, "http://dbpedia.org/resource/Virga"))),
                new HashSet<ExtendedTypedNamedEntity>(Arrays.asList(new ExtendedTypedNamedEntity(28, 30,
                        CetusSurfaceFormExtractor.BASE_URI + "ObservablePrecipitationShaft",
                        new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "observable precipitation shaft"),
                        new ExtendedTypedNamedEntity(39, 19, CetusSurfaceFormExtractor.BASE_URI + "PrecipitationShaft",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "precipitation shaft"),
                        new ExtendedTypedNamedEntity(53, 5, CetusSurfaceFormExtractor.BASE_URI + "Shaft",
                                new HashSet<String>(Arrays.asList(RDFS.Class.getURI())), "shaft"))) });
        return testConfigs;
    }
